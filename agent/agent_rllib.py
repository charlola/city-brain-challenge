...
from agent.colight import gym_cfg
...
class TestAgent():
    def __init__(
        ...
        if self._algorithm == "PPO":
            ...
            from ray.rllib.agents.a3c.a3c_torch_policy import A3CTorchPolicy as LoadPolicy
        elif self._algorithm == "PG":
            from ray.rllib.agents.pg.pg_torch_policy import PGTorchPolicy as LoadPolicy
